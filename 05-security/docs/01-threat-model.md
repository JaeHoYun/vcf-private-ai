...
OWASP 2025 개정에서 시스템 프롬프트 유출(LLM07)과 벡터·임베딩 약점(LLM08)이 신규 진입했으며, 프롬프트 인젝션(LLM01)은 직접·간접 인젝션을 모두 포괄하도록 정의가 확장되었습니다([OWASP GenAI](https://genai.owasp.org/resource/owasp-top-10-for-llm-applications-2025/)). RAG 파이프라인을 다루는 앞 시리즈는 [④ RAG 레퍼런스](../../04-rag/README.md)를 참조하세요.
