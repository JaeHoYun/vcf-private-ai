...
→ **[산업 유스케이스 — 결과·KPI로 보는 에이전트](https://github.com/JaeHoYun/vcf-private-ai-agents/blob/main/docs/08-use-cases.md)** (제조 사례: 기술문서 Q&A · 품질 이상 분석 · 설비 보전)

## 시작하기 전에 (Primer)

이 시리즈는 독자가 임베딩·벡터·토큰·RAG·에이전트, 그리고 쿠버네티스(VKS)를 **이미 안다고** 전제합니다. 그 출발선이 아직 낯설다면, 본편에 앞서 입문 자료로 기초 어휘를 먼저 잡으시길 권합니다.

→ **[VCF Private AI 입문 (Primer)](00-foundations/README.md)** — 인프라 엔지니어를 위한 AI 101, vSphere 관리자를 위한 K8S/VKS 101, 통합 용어집. 시리즈 번호(①–⑦)에 속하지 않는 별도 입문 트랙입니다. 본편을 이미 편하게 읽고 있다면 건너뛰어도 됩니다.
