...
**멀티테넌시와 GPU 공유 설계 결정** — 격리 강도(D10)는 [⑤ 5.1](05-tenancy-security.md#51-결정-멀티테넌시-격리--soft네임스페이스-vs-hard클러스터와-도메인-분리), GPU 공유 방식(D2)은 [⑥ 6.1 결정 색인](06-decision-forks.md#61-결정-색인-12건)에서 결정 요인에 맞춰 고르시기 바랍니다.
