...
| --- | --- | --- | --- |
| 인력(운영과 플랫폼, 선택) | 운영 FTE(전임 환산 인력) 수 | 인건비 × FTE | (산정 입력) |
...
메모:
- **인력비는 선택 항목:** 해외 TCO 비교는 운영 인력비를 넣는 경우가 많지만, 국내에서는 기존 인력이 맡는 운영을 TCO에 넣지 않는 경우가 대부분입니다. 넣든 빼든 온프레미스와 퍼블릭 클라우드 양쪽에 같은 기준을 적용해야 비교가 공정합니다.
