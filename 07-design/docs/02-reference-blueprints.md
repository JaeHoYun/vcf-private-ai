...
> 본 문서의 구성값은 작성 시점(2026-06, 9.1.1과 PAIS 3.0 GA 반영 2026-09) VCF 9.1.1 / PAIF 9.1.1 / PAIS 3.0 기준 **예시**이며, 실제 규모·구성은 [01 결정 요인](01-design-process.md)과 ⑥ 사이징으로 검증하시기 바랍니다.
