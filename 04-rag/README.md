...
> **"사내 정책과 기술 문서 수천 건을 학습한 Q&A 봇"** — 직원이 자연어로 질문하면, 사내 문서에서 근거를 찾아 출처와 함께 답한다. 데이터는 사내를 벗어나지 않는다.
...
- **"검색 품질이 안 나온다"** → [03 검색과 조립](docs/03-retrieval-context.md) + [06 평가](docs/06-evaluation-quality.md)
